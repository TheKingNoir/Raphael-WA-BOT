...
export const defSets = {
  self: 0,
  prefix: '[\"/\",\"!\",\".\",\"#\"]',
  newsletter_id: '120363314989471034@newsletter',
  nameid: 'ᨳ︪︩፝֟͝    ␥ ⃟𝐑𝐚𝐩𝐡𝐚𝐞𝐥 BOT ᶜʰᵃⁿⁿᵉˡ',
  type: 'Owner',
  link: 'https://komodo-host.site',
  banner: 'https://files.yuki-wabot.my.id/cdn/nxjZFw0J.jpeg',
  currency: 'Yenes',
  namebot: 'Raphael',
  botname: 'Raphael',
  owner: ''
...
export function initDB() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS settings (
      ...
      prefix TEXT DEFAULT '[\"/\",\"!\",\".\",\"#\"]',
      newsletter_id TEXT DEFAULT '120363314989471034@newsletter',
      nameid TEXT DEFAULT 'ᨳ︪︩፝֟͝    ␥ ⃟𝐑𝐚𝐩𝐡𝐚𝐞𝐥 BOT ᶜʰᵃⁿⁿᵉˡ',
      type TEXT DEFAULT 'Owner',
      link TEXT DEFAULT 'https://komodo-host.site',
      banner TEXT DEFAULT 'https://files.yuki-wabot.my.id/cdn/nxjZFw0J.jpeg',
