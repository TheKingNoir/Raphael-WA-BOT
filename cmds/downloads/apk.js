...
export default {
  ...
  run: async ({ msg, sock, args, usedPrefix, command }) => {
    ...
    try {
      ...
      await sock.sendMessage(msg.chat, { document: { url: downloadUrl }, mimetype: 'application/vnd.android.package-archive', fileName: `${name}.apk`, jpegThumbnail: thumbBuffer2, caption }, { quoted: msg })
    } catch (e) {
