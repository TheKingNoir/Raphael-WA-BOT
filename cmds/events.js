    ...
    try {
      ...
      for (const p of anu.participants) {
        ...
        const pp = await sock
          ...
          .catch(() => 'https://files.yuki-wabot.my.id/cdn/2PVh.jpeg');
...
ᨳ︪︩፝֟͝    ␥ ⃟𝐑𝐚𝐩𝐡𝐚𝐞𝐥 ²⁰²⁶ ©`;
          ...
          if (fs.existsSync('./media/bienvenida.mp3')) {
            await sock.sendMessage(anu.id, {
              audio: fs.readFileSync('./media/bienvenida.mp3'),
              mimetype: 'audio/mpeg',
              ptt: true
            });
          }
...
┊ *🌐 Ahora somos【👥 ${memberCount}】 miembros.*
┊┈─────̇─̇─̇───────────◯◝
┊ ✨ Que te vaya bien lejos de aqui.
┊ ───────✧₊∘℘∘₊✧───────
╰─────────────────────╯
ᨳ︪︩፝֟͝    ␥ ⃟𝐑𝐚𝐩𝐡𝐚𝐞𝐥 ²⁰²⁶ ©`;
          }
        ...
        // Promote y demote desactivados intencionalmente.
        ...
        //   const authorJid = normalizeJid(anu.author) || anu.author;
        //   await sock.sendMessage(anu.id, {
        //     text: `「 ⬇️ 」 *@${phone}* ha sido degradado de Administrador por *@${authorJid.split('@')[0]}.*`,
        //     mentions: [jid, authorJid, ...groupAdmins]
        //   });
        // }
      }
