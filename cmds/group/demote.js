export default {
  ...
  run: async ({ msg, sock, usedPrefix, command, groupMetadata, participants }) => {
    ...
    try {
      ...
      if (ownerBots.includes(targetJid)) return msg.reply('《✧》 No puedes degradar al creador del bot de administrador.');
...
├───────────────◆
│ 👤 *Usuario:* @${whoBase}
│ ⬇️ *¡Degradado con éxito!*
│ ⚙️ *Acción Hecha Por:* @${msg.sender.split('@')[0]}
╰───────────────◆
ᨳ︪︩፝֟͝    ␥ ⃟𝐑𝐚𝐩𝐡𝐚𝐞𝐥 ²⁰²⁶ ©`, mentions: [who, msg.sender ]}, { quoted: msg });
